...
| Task | Command |
| --- | --- |
| Impact analysis | `npx gitnexus impact <symbol> --direction upstream --repo 9router-patcher` |
| Deep context | `npx gitnexus context <symbol> --repo 9router-patcher` |
| Query flows | `npx gitnexus query "<concept>" --repo 9router-patcher` |
| Pre-commit diff check | `npx gitnexus detect-changes --repo 9router-patcher` |
| Re-index codebase | `npx gitnexus analyze` |

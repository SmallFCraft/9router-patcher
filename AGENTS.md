...
This project is indexed by GitNexus as **9router-patcher** (962 symbols, 2080 relationships, 86 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
